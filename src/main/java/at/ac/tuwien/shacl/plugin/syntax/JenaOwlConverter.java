...
public synchronized Model ModelOwlToJenaConvert2(OWLOntology owlmodel,String format){
...
public synchronized StmtIterator EntityOwlToJenaResource(OWLEntity entity,OWLOntology owlmodel,String format){
    ...
    if(entity.isOWLClass()){
        ...
        Iterator<OWLAnnotationAssertionAxiom> annotations = ((OWLAxiomIndex) entity).getAnnotationAssertionAxioms((OWLAnnotationSubject) owlmodel).iterator();
